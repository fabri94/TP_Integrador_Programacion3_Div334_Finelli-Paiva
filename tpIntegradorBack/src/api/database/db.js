...
//Hacemos destructuring para guardar en la variable environments la info de la BBDD
...
/* Que hace el metodo .createPool?
    ...
    - se conecta a la bbdd usando los parametros (host, user, pass, etc)
    - por defecto, abre hasta 10 conexiones simultaneas (se puede configurar esto)
...
En lugar de abrir y cerrar una conexion c/vez que hacemos una consulta, el pool:
    - Mantiene abiertas varias conexiones
    - Las reutiliza para != consultas
